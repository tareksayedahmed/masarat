...
const AboutPage: React.FC = () => {
  return (
    <div>
      <h1 className="text-4xl font-extrabold mb-8 text-center text-gray-900 dark:text-gray-100">عن مسارات لتأجير السيارات</h1>
      <Card className="p-8 space-y-4 max-w-4xl mx-auto bg-white dark:bg-gray-800">
