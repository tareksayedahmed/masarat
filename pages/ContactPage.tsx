...
const ContactPage: React.FC = () => {
  return (
    <div>
      <h1 className="text-4xl font-extrabold mb-8 text-center text-gray-900 dark:text-gray-100">تواصل معنا</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
        ...
        <Card className="p-8 bg-white dark:bg-gray-800">
          ...
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); alert('شكراً لك، تم إرسال رسالتك بنجاح!'); }}>
            ...
            <div>
                <label htmlFor="message" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">رسالتك</label>
                <textarea 
                    id="message" 
                    rows={4} 
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
